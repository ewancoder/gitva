...
| double-click a tree | fold or unfold that subtree; folded, it says how many entries it is holding back in bold (`tree +3`) and grows a green arrow off its right edge. Trees arrive open |
